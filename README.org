...
#+END_SRC
** Font
I'm trying to use a font like Menlo that is going to be pre-installed
on just about every OS, so I can cut back on the amount of fiddling I
have to do to get Emacs and other apps looking the way I want them to.
#+BEGIN_SRC emacs-lisp
