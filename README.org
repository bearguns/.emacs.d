...
* Theme
** Solarized Theme
Solarized continues to be a solid go-to, and while I need to tweak
some things (I hate italics, for one), it just looks nice and is easy
on my eyes.
#+BEGIN_SRC emacs-lisp
...
[[https://github.com/technomancy/find-file-in-project][Find File in Project]] is a great, small library for quickly finding
files inside of a VCS project (Git/Mercurial/SVN/etc).
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** JavaScript
I'm giving JS2-Mode another try, mostly for the (slightly) better
syntax highlighting.
#+BEGIN_SRC emacs-lisp
