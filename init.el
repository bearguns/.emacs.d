...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ranger ace-window yasnippet web-mode use-package smartparens rainbow-delimiters magit emmet-mode editorconfig counsel-projectile company atom-one-dark-theme))))
(custom-set-faces
